...
# 订单模块---修改订单
from main.order.modify_order.modify_order import modify_order  # 修改订单
# 公共模块
...
from main.public.judge_user.judge_user import judge_user  # 判断用户类型
...
# 订单模块---修改订单
app.register_blueprint(modify_order, url_prefix='/order')  # 修改订单
# 公共模块
...
app.register_blueprint(judge_user, url_prefix='/public')  # 判断用户类型
